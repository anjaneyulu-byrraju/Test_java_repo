							...
							<li>
								<div>
									<div class="commenterImage">
										<img src="resources/images/<%= comment.getAuthor().getUsername() %>.png" /><%=HtmlUtils.htmlEscape(comment.getAuthor().getUsername())%>										<img src="resources/images/<%= comment.getAuthor().getUsername() %>.png" />
									</div>
