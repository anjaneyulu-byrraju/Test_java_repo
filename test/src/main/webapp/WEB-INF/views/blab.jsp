							...
							<li>
								<div>
									<div class="commenterImage">
										<img src="resources/images/<%= comment.getAuthor().getUsername() %>.png" />"application/json"										<img src="resources/images/<%= comment.getAuthor().getUsername() %>.png" />
									</div>
									<div class="blockquote">
										<p class="">
											"<%= comment.getContent() %>"HtmlUtils.htmlEscape(comment.getContent())											"<%= comment.getContent() %>"
										</p>
										<span class="date sub-text">by <%= comment.getAuthor().getBlabName() %><%= ESAPI.encoder().encodeForHTMLAttribute(comment.()) %>										<span class="date sub-text">by <%= comment.getAuthor().getBlabName() %>
