								...
								<div>
									...
									<div class="commentText">
										...
										<span class="date sub-text">
											by <%= post.getAuthor().getBlabName() %> on <%= post.getPostDateString() %>by <%= ESAPI.encoder().encodeForHTMLAttribute(post.getPostDateString()) %>											by <%= post.getAuthor().getBlabName() %> on <%= post.getPostDateString() %>
										</span>
										<br/>
										<span class="date sub-text">
